...
function App() {
  return (
    <div className="App">
      <h1>Termos e condições BWS Track</h1>
      <div>
      ...
      <div>
        ...
        informações, a qualquer momento, entrando em contato conosco em natan@bwsiot.com ou nos
        enviando uma correspondência em: BWSIOT Praça das Tulipas,26,1° e 2° andar CentroAlphaville Comercial Barueri-SP,06453-021</p>
      </div>
      <div>
